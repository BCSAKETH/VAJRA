    ...
    def chat(
        ...
        if tools:
            system_prompt = (
                ...
                "for multi-part answers. Formatting the chat UI renders: **bold** for key facts/names, a blank "
                "line between paragraphs, and a markdown pipe table ONLY when directly comparing two or more "
                "named entities (e.g. two suspects' risk scores) -- not for a single list, that's a bullet list "
                "instead. Wrap an exact ID/hash/case-number in `backticks` when quoting it verbatim. "
            ...
            system_prompt = (
                ...
                "Formatting the chat UI renders: **bold** for key facts/names, a blank line between paragraphs, "
                "and a markdown pipe table ONLY when directly comparing two or more named entities -- not for a "
                "single list, that's a bullet list instead. Wrap an exact ID/hash/case-number in `backticks` when "
                "quoting it verbatim. "
