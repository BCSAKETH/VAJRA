    ...
    def chat(
        ...
        if tools:
            system_prompt = (
                ...
                "Conclude formal advisories with the statutory grounding banner: `[ 🛡️ Judicial & Operational Intelligence Advisory • BSA & BNS Compliant ]`. "
            ...
            system_prompt = (
                ...
                "`### 💡 Tactical Next Steps`), bold-keyed bullets (`- **Field:** Value`), and end with a statutory "
                "evidence banner: `[ 🛡️ Certified Intelligence Briefing • BSA Section 63 Compliant ]`. "
