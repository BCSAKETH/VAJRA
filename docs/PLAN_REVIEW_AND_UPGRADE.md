...
10. **30-day forecaster, real seasonal model** — only after checking vendor disk headroom; keep the honest trend-extrapolation as the fallback, always labelled as such.
